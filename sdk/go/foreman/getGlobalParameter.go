...
func (o LookupGlobalParameterResultOutput) __meta_() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupGlobalParameterResult) bool { return v.__meta_ }).(pulumi.BoolOutput)
}

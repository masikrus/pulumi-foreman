...
func (o LookupKatelloContentViewResultOutput) __meta_() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupKatelloContentViewResult) bool { return v.__meta_ }).(pulumi.BoolOutput)
}

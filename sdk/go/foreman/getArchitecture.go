...
func (o LookupArchitectureResultOutput) __meta_() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupArchitectureResult) bool { return v.__meta_ }).(pulumi.BoolOutput)
}

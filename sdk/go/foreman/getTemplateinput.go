...
func (o LookupTemplateinputResultOutput) __meta_() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupTemplateinputResult) bool { return v.__meta_ }).(pulumi.BoolOutput)
}

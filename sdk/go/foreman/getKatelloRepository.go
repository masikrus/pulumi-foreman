...
func (o LookupKatelloRepositoryResultOutput) __meta_() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupKatelloRepositoryResult) bool { return v.__meta_ }).(pulumi.BoolOutput)
}

...
func NewProvider(ctx *pulumi.Context,
	...
	if args.ClientPassword == nil {
		if d := internal.GetEnvOrDefault(nil, nil, "FOREMAN_CLIENT_PASSWORD"); d != nil {
			args.ClientPassword = pulumi.StringPtr(d.(string))
		}
	}
	if args.ClientUsername == nil {
	...
	if args.ServerProtocol == nil {
		if d := internal.GetEnvOrDefault(nil, nil, "FOREMAN_PROTOCOL"); d != nil {
			args.ServerProtocol = pulumi.StringPtr(d.(string))
		}
	}
...
// The hostname / IP address of the Foreman REST API server
func (o ProviderOutput) ServerHostname() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.ServerHostname }).(pulumi.StringPtrOutput)
}

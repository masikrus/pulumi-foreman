...
func GetClientPassword(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "foreman:clientPassword")
	if err == nil {
		return v
	}
	var value string
	if d := internal.GetEnvOrDefault(nil, nil, "FOREMAN_CLIENT_PASSWORD"); d != nil {
		value = d.(string)
	}
	return value
}
...
func GetClientUsername(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "foreman:clientUsername")
	if err == nil {
		return v
	}
	var value string
	if d := internal.GetEnvOrDefault(nil, nil, "FOREMAN_CLIENT_USERNAME"); d != nil {
		value = d.(string)
	}
	return value
}
...
func GetServerHostname(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "foreman:serverHostname")
	if err == nil {
		return v
	}
	var value string
...
func GetServerProtocol(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "foreman:serverProtocol")
	if err == nil {
		return v
	}
	var value string
	if d := internal.GetEnvOrDefault(nil, nil, "FOREMAN_PROTOCOL"); d != nil {
		value = d.(string)
	}
	return value
}

...
namespace Pulumi.Foreman
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Foreman.version.txt");
    ...
    internal sealed class ForemanResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ForemanResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

module github.com/masikrus/pulumi-foreman/provider
...
require (
	...
	github.com/terraform-coop/terraform-provider-foreman v0.7.0
)
...
require (
	...
	github.com/HanseMerkur/terraform-provider-utils v1.3.1 // indirect
